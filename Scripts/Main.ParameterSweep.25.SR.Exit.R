...
# set parameters  ---------------------------------------------------------
n = 50                   # number of runs per parameter sweep
Mosquitoes = 25
num.exp.days = 5
kd.interval.factor = 2
num.sim = 50             # number of different simulations
...
save(list = ls(), file = 'workspace.parametersweeps.25.RData')
# Figure of likelihoods------------------------------------------------------------------
setwd(path)

pdf('LL.sweep.25.pdf',width=4.75,height=4.75)
...
pdf('LL.sweep.RealvsEstimated.25.pdf',width=4.75,height=4.75)
par(mfrow = c(4,3),mai=c(0.3,0.3,0.3,0.1) ,oma=c(3,4,1,1))  #mar=c(1,3,1,1.9)
